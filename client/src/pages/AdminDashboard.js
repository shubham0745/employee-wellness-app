...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      try {
        const res = await axios.get(`${process.env.REACT_APP_API_URL}https://employee-wellness-app.onrender.com/api/questions`, {
  ...
  useEffect(() => {
    const fetchHistory = async () => {
      try {
        const res = await axios.get(`${process.env.REACT_APP_API_URL}https://employee-wellness-app.onrender.com/api/assessment/all`, {
          headers: { Authorization: `Bearer ${token}` },
        });
  ...
  const toggleQuestion = async (id) => {
    try {
      const res = await axios.patch(
        `${process.env.REACT_APP_API_URL}https://employee-wellness-app.onrender.com/api/questions/${id}`,
        {},
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const handleReminderSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(
        `${process.env.REACT_APP_API_URL}https://employee-wellness-app.onrender.com/api/admin/reminder-settings`,
        reminderSettings,
        { headers: { Authorization: `Bearer ${token}` } }
      );
